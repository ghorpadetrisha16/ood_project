...
public class Imunnization extends Student {
    ...
    public Imunnization(int studentId, String studentName, int age, String dateofBirth, double gpa, String svid, String nextDueDate, int tempSID, String lastVaccineDate, LocalDate[] ld, LocalDate[] nd) {
    ...
    public Imunnization(String svid, String nextDueDate, int tempSID, String lastVaccineDate, LocalDate[] ld, LocalDate[] nd) {
        this.svid = svid;
        this.nextDueDate = nextDueDate;
        this.tempSID = tempSID;
        this.lastVaccineDate = lastVaccineDate;
